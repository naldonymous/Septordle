...
export default function Game() {
  ...
  const { guesses, currGuess, setCurrGuess, gameOver, message, shake, keyColors, handleOnScreenKey } = useGameLogic(solution);
  ...
  return (
    <main className="flex flex-col items-center gap-10 relative px-4">
      ...
      <Keyboard onKey={handleOnScreenKey}
                keyColors={keyColors}
        />
    </main>
  );
